...
Я Алексей, **Fullstack-разработчик на Python**. Специализируюсь на создании эффективных и надежных веб-приложений, используя современные технологии и лучшие практики разработки.
...
- ✅ **[Свидетельство о завершении обучения - Курс "Python-разработчик"](https://disk.yandex.ru/i/ly9LkHkF5ua0kg)** 
...
- ✅ **[Сертификат о прохождении стажировки - Победа Digital Agency](https://disk.yandex.ru/i/-VO6m8ySqTrLaA)** - Веб-разработка (14.10.2025 - 14.12.2025)
...
### Стажировка - Победа Digital Agency
**Веб-разработка** | *14 октября 2025 - 14 декабря 2025*

За время стажировки занимался разработкой парсер-системы для внутренних нужд компании. Основная задача заключалась в создании инструмента для анализа репутации компаний на основе данных с картографических сервисов (2ГИС и Яндекс Карты).

**Ключевые достижения:**
- Разработка веб-приложения для поиска и анализа карточек компаний
- Сбор статистики: рейтинги, отзывы, скорость ответов, тональность
- Реализация асинхронного процесса парсинга с email-уведомлениями
- Создание защищенной системы доступа с возможностью скачивания отчетов в PDF
- Интеграция с внешними API картографических сервисов

**Технологии**: Python, FastAPI, Selenium, Docker, PostgreSQL, Email notifications
...
> **Алексей показал себя как ответственного и увлеченного сотрудника, способного работать со сложными техническими задачами. Он продемонстрировал понимание процессов веб-разработки, навыки работы с внешними API.**

**Дмитрий Ложкин**  
Генеральный директор, Победа Digital Agency

*Стажировка пройдена в полной программе.*  
*Период: 14 октября 2025 - 14 декабря 2025*

📄 **[Просмотреть отзыв о прохождении стажировки](https://disk.yandex.ru/i/Ul3Ei8XKg2qqFQ)**
...
[![Telegram](https://img.shields.io/badge/Telegram-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/LexxDramma)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:lexxdramma@vk.com)
